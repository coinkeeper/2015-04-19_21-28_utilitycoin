...
// UtilityCoin: total coins staked (non-spendable until maturity)
...
// UtilityCoin: check 'spent' consistency between wallet and txindex
// UtilityCoin: fix wallet spent state according to txindex
...
// UtilityCoin: disable transaction (only for coinstake)
